...
/**
 * This class provides functions to manipulate byte arrays in the programmer-friendly
 * hexadecimal octet format.
 */
public final class HexUtil
{
	...
	/**
	 * Converts a byte array to string in a special form.
	 * <BR><BR>
	 * On the left side of the generated string, each byte is printed as
	 * a hex octet with a trailing space.<BR>
	 * On the right side of the generated string, each byte is printed as
	 * an ASCII char, unless it's a non-printing character (the same is
	 * done to extended ASCII characters): then a period is printed instead.

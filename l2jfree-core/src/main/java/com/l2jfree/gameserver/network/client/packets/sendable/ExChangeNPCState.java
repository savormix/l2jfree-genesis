 ...
 */
public abstract class ExChangeNPCState extends L2ServerPacket
{
	/**
	 * A nicer name for {@link ExChangeNPCState}.
	 * 
	 * @author savormix (generated)
	...
	private static final int[] EXT_OPCODES = { 0xbe, 0x00, };
	
	/** Constructs this packet. */
	public ExChangeNPCState()
	{
	}

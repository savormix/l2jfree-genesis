 ...
 */
public abstract class RequestDropItemPacket extends L2ClientPacket
{
	/**
	 * A nicer name for {@link RequestDropItemPacket}.
	 * 
	 * @author savormix (generated)
	 * @see RequestDropItemPacket
	 */
	...
	{
		return READ_D + READ_Q + READ_D + READ_D + READ_D;
	}

 ...
 */
public abstract class RequestWriteHeroWords extends L2ClientPacket
{
	/**
	 * A nicer name for {@link RequestWriteHeroWords}.
	 * 
	 * @author savormix (generated)
	 * @see RequestWriteHeroWords
	 */
	...
	public static final int[] EXT_OPCODES = { 0x05, 0x00 };
	/** Second packet's identifier */
	public static final int OPCODE_2 = 0x05;

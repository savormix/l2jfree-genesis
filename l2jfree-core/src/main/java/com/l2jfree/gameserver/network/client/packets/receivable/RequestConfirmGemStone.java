 ...
 */
public abstract class RequestConfirmGemStone extends L2ClientPacket
{
	/**
	 * A nicer name for {@link RequestConfirmGemStone}.
	 * 
	 * @author savormix (generated)
	 * @see RequestConfirmGemStone
	 */
	...
	public static final int[] EXT_OPCODES = { 0x28, 0x00 };
	...
	{
		return READ_D + READ_D + READ_D + READ_Q;
	}
	...
	protected void read(MMOBuffer buf) throws BufferUnderflowException, RuntimeException
	{
		...
		buf.readD(); // Gemstone OID
		buf.readQ(); // Gemstone quantity
	}

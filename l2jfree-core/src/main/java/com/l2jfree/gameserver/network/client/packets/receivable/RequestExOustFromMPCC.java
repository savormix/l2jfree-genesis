 ...
 */
public abstract class RequestExOustFromMPCC extends L2ClientPacket
{
	/**
	 * A nicer name for {@link RequestExOustFromMPCC}.
	 * 
	 * @author savormix (generated)
	 * @see RequestExOustFromMPCC
	 */
	...
	public static final int[] EXT_OPCODES = { 0x08, 0x00 };

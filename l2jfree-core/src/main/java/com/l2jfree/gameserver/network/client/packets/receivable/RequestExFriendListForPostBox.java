 ...
 */
public abstract class RequestExFriendListForPostBox extends L2ClientPacket
{
	/**
	 * A nicer name for {@link RequestExFriendListForPostBox}.
	 * 
	 * @author savormix (generated)
	 * @see RequestExFriendListForPostBox
	 */
	...
	public static final int[] EXT_OPCODES = { 0x87, 0x00, };
	/** Second packet's identifier */
	public static final int OPCODE_2 = 0x87;

 ...
 */
public abstract class RequestDeleteSentPost extends L2ClientPacket
{
	/**
	 * A nicer name for {@link RequestDeleteSentPost}.
	 * 
	 * @author savormix (generated)
	...
	public static final int[] EXT_OPCODES = { 0x6d, 0x00 };

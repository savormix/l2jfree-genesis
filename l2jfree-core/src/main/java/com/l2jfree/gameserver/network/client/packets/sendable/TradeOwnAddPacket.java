 ...
 */
public abstract class TradeOwnAddPacket extends L2ServerPacket
{
	/**
	 * A nicer name for {@link TradeOwnAddPacket}.
	 * 
	 * @author savormix (generated)
	 * @see TradeOwnAddPacket
	 */
	public static final class MyItemOffered extends TradeOwnAddPacket
	{
		/**
		 * Constructs this packet.
		 * 
		 * @see TradeOwnAddPacket#TradeOwnAddPacket()
		 */
		public MyItemOffered()
		{
		}
	}
	
	/** Constructs this packet. */
	public TradeOwnAddPacket()
	{
	}

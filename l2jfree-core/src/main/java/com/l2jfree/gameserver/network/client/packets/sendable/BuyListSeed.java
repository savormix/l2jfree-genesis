 ...
 */
public abstract class BuyListSeed extends L2ServerPacket
{
	/**
	 * A nicer name for {@link BuyListSeed}.
	 * 
	 * @author savormix (generated)
	 * @see BuyListSeed
	 */
	public static final class SeedList extends BuyListSeed
	{
		/**
		 * Constructs this packet.
		 * 
		 * @see BuyListSeed#BuyListSeed()
		 */
		public SeedList()
		{
		}

 ...
 */
public abstract class MoveToLocationInVehicle extends L2ServerPacket
{
	/**
	 ...
	 */
	public static final class MoveInVehicle extends MoveToLocationInVehicle
	{
		/**

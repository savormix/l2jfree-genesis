 ...
 */
public abstract class RequestExFishRanking extends L2ClientPacket
{
	/**
	 * A nicer name for {@link RequestExFishRanking}.
	 * 
	 * @author savormix (generated)
	 * @see RequestExFishRanking
	 */
	...
	public static final int[] EXT_OPCODES = { 0x18, 0x00 };
	/** Second packet's identifier */
	public static final int OPCODE_2 = 0x18;

 ...
 */
public abstract class ExReplyPostItemList extends L2ServerPacket
{
	/**
	 * A nicer name for {@link ExReplyPostItemList}.
	 * 
	 * @author savormix (generated)
	 * @see ExReplyPostItemList
	 */
	public static final class AttachableItemList extends ExReplyPostItemList
	{
		/**
		 * Constructs this packet.
		 * 
		 * @see ExReplyPostItemList#ExReplyPostItemList()
		 */
		public AttachableItemList()
		{
		}
	}
	
	private static final int[] EXT_OPCODES = { 0xb2, 0x00, };
	
	/** Constructs this packet. */
	public ExReplyPostItemList()
	{
	}

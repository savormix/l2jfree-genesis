 ...
 */
public abstract class RequestpartyLootModification extends L2ClientPacket
{
	/**
	 * A nicer name for {@link RequestpartyLootModification}.
	 * 
	 * @author savormix (generated)
	 * @see RequestpartyLootModification
	 */
	...
	public static final int[] EXT_OPCODES = { 0x78, 0x00, };
	/** Second packet's identifier */
	public static final int OPCODE_2 = 0x78;

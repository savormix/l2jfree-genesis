 ...
 */
public abstract class TradeOtherAddPacket extends L2ServerPacket
{
	/**
	 * A nicer name for {@link TradeOtherAddPacket}.
	 * 
	 * @author savormix (generated)
	 * @see TradeOtherAddPacket
	 */
	public static final class ItemOffered extends TradeOtherAddPacket
	{
		/**
		 * Constructs this packet.
		 * 
		 * @see TradeOtherAddPacket#TradeOtherAddPacket()
		 */
		public ItemOffered()
		{
		}

 ...
 */
public abstract class RequestRejectPost extends L2ClientPacket
{
	/**
	 * A nicer name for {@link RequestRejectPost}.
	 * 
	 * @author savormix (generated)
	 * @see RequestRejectPost
	 */
	...
	public static final int[] EXT_OPCODES = { 0x6b, 0x00 };

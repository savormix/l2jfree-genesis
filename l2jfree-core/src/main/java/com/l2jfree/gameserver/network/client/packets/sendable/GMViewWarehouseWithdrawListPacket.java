 ...
 */
public abstract class GMViewWarehouseWithdrawListPacket extends L2ServerPacket
{
	/**
	 * A nicer name for {@link GMViewWarehouseWithdrawListPacket}.
	 * 
	 * @author savormix (generated)
	 * @see GMViewWarehouseWithdrawListPacket
	 */
	public static final class ViewWarehouse extends GMViewWarehouseWithdrawListPacket
	{
		/**
		 * Constructs this packet.
		 * 
		 * @see GMViewWarehouseWithdrawListPacket#GMViewWarehouseWithdrawListPacket()
		 */
	...
	/** Constructs this packet. */
	public GMViewWarehouseWithdrawListPacket()
	{
	}

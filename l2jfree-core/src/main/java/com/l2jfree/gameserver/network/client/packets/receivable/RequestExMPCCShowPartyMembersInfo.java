 ...
 */
public abstract class RequestExMPCCShowPartyMembersInfo extends L2ClientPacket
{
	/**
	 * A nicer name for {@link RequestExMPCCShowPartyMembersInfo}.
	 * 
	 * @author savormix (generated)
	 * @see RequestExMPCCShowPartyMembersInfo
	 */
	...
	public static final int[] EXT_OPCODES = { 0x2d, 0x00, };
	...
	protected void read(MMOBuffer buf) throws BufferUnderflowException, RuntimeException
	{
		...
		buf.readD(); // Party leader's(Member's) OID
	}

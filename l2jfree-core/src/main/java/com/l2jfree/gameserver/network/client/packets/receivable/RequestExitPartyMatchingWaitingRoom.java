 ...
 */
public abstract class RequestExitPartyMatchingWaitingRoom extends L2ClientPacket
{
	/**
	 * A nicer name for {@link RequestExitPartyMatchingWaitingRoom}.
	 * 
	 * @author savormix (generated)
	 * @see RequestExitPartyMatchingWaitingRoom
	 */
	...
	public static final int[] EXT_OPCODES = { 0x25, 0x00 };

 ...
 */
public abstract class RequestRequestReceivedPostList extends L2ClientPacket
{
	/**
	 * A nicer name for {@link RequestRequestReceivedPostList}.
	 * 
	 * @author savormix (generated)
	 * @see RequestRequestReceivedPostList
	 */
	...
	public static final int[] EXT_OPCODES = { 0x67, 0x00 };

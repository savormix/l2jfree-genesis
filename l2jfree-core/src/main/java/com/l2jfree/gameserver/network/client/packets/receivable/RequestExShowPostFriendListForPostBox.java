 ...
 */
public abstract class RequestExShowPostFriendListForPostBox extends L2ClientPacket
{
	/**
	 * A nicer name for {@link RequestExShowPostFriendListForPostBox}.
	 * 
	 * @author savormix (generated)
	 * @see RequestExShowPostFriendListForPostBox
	 */
	...
	public static final int[] EXT_OPCODES = { 0x86, 0x00 };

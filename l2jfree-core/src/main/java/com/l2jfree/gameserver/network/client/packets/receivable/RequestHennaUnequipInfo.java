 ...
 */
public abstract class RequestHennaUnequipInfo extends L2ClientPacket
{
	/**
	 * A nicer name for {@link RequestHennaUnequipInfo}.
	 * 
	 * @author savormix (generated)
	 * @see RequestHennaUnequipInfo
	 */
	...
	/** Constructs this packet. */
	public RequestHennaUnequipInfo()
	{
	}

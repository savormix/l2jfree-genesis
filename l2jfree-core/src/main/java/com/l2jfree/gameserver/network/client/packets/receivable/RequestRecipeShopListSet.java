 ...
 */
public abstract class RequestRecipeShopListSet extends L2ClientPacket
{
	/**
	 * A nicer name for {@link RequestRecipeShopListSet}.
	 * 
	 * @author savormix (generated)
	 * @see RequestRecipeShopListSet
	 */
	...
	protected void read(MMOBuffer buf) throws BufferUnderflowException, RuntimeException
	{
		...
		final int sizeA = buf.readD(); // Recipe count

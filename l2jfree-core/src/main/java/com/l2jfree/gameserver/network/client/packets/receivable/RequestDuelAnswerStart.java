 ...
 */
public abstract class RequestDuelAnswerStart extends L2ClientPacket
{
	/**
	 * A nicer name for {@link RequestDuelAnswerStart}.
	 * 
	 * @author savormix (generated)
	 * @see RequestDuelAnswerStart
	 */
	...
	public static final int[] EXT_OPCODES = { 0x1c, 0x00, };
	/** Second packet's identifier */
	public static final int OPCODE_2 = 0x1c;

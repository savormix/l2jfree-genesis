 ...
 */
public abstract class RequestExCancelEnchantItem extends L2ClientPacket
{
	/**
	 * A nicer name for {@link RequestExCancelEnchantItem}.
	 * 
	 * @author savormix (generated)
	 * @see RequestExCancelEnchantItem
	 */
	...
	public static final int[] EXT_OPCODES = { 0x4e, 0x00 };
	/** Second packet's identifier */
	public static final int OPCODE_2 = 0x4e;

 ...
 */
public abstract class RequestSendMsnChatLog extends L2ClientPacket
{
	/**
	 * A nicer name for {@link RequestSendMsnChatLog}.
	 * 
	 * @author savormix (generated)
	 * @see RequestSendMsnChatLog
	 */
	...
	protected void read(MMOBuffer buf) throws BufferUnderflowException, RuntimeException
	{
		...
		buf.readS(); // Message
		buf.readS(); // Contact (account name)
		buf.readD(); // Type
	}

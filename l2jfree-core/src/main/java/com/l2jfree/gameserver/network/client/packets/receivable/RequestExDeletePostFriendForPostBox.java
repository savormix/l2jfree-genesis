 ...
 */
public abstract class RequestExDeletePostFriendForPostBox extends L2ClientPacket
{
	/**
	 * A nicer name for {@link RequestExDeletePostFriendForPostBox}.
	 * 
	 * @author savormix (generated)
	 * @see RequestExDeletePostFriendForPostBox
	 */
	...
	public static final int[] EXT_OPCODES = { 0x85, 0x00, };

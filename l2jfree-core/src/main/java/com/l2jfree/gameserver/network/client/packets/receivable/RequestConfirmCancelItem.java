 ...
 */
public abstract class RequestConfirmCancelItem extends L2ClientPacket
{
	/**
	 * A nicer name for {@link RequestConfirmCancelItem}.
	 * 
	 * @author savormix (generated)
	 * @see RequestConfirmCancelItem
	 */
	...
	public static final int[] EXT_OPCODES = { 0x42, 0x00, };
	/** Second packet's identifier */
	public static final int OPCODE_2 = 0x42;

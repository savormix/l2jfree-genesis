 ...
 */
public abstract class RequestExMagicSkillUseGround extends L2ClientPacket
{
	/**
	 * A nicer name for {@link RequestExMagicSkillUseGround}.
	 * 
	 * @author savormix (generated)
	 * @see RequestExMagicSkillUseGround
	 */
	...
	public static final int[] EXT_OPCODES = { 0x44, 0x00, };
	...
	{
		return READ_D + READ_D + READ_D + READ_D + READ_D + READ_C;
	}

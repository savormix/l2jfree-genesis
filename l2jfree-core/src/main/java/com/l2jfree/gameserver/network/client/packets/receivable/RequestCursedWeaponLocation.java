 ...
 */
public abstract class RequestCursedWeaponLocation extends L2ClientPacket
{
	/**
	 * A nicer name for {@link RequestCursedWeaponLocation}.
	 * 
	 * @author savormix (generated)
	 * @see RequestCursedWeaponLocation
	 */
	...
	public static final int[] EXT_OPCODES = { 0x2b, 0x00 };

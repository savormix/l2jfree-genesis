 ...
 */
public abstract class RequestOlympiadMatchList extends L2ClientPacket
{
	/**
	 * A nicer name for {@link RequestOlympiadMatchList}.
	 * 
	 * @author savormix (generated)
	 * @see RequestOlympiadMatchList
	 */
	...
	public static final int[] EXT_OPCODES = { 0x2e, 0x00, };
	/** Second packet's identifier */
	public static final int OPCODE_2 = 0x2e;

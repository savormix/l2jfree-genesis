 ...
 */
public abstract class RequestPCCafeCouponUse extends L2ClientPacket
{
	/**
	 * A nicer name for {@link RequestPCCafeCouponUse}.
	 * 
	 * @author savormix (generated)
	 * @see RequestPCCafeCouponUse
	 */
	...
	public static final int[] EXT_OPCODES = { 0x19, 0x00 };
	/** Second packet's identifier */
	public static final int OPCODE_2 = 0x19;

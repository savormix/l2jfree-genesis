 ...
 */
public abstract class RequestExChangeName extends L2ClientPacket
{
	/**
	 * A nicer name for {@link RequestExChangeName}.
	 * 
	 * @author savormix (generated)
	 * @see RequestExChangeName
	 */
	...
	public static final int[] EXT_OPCODES = { 0x3b, 0x00 };

 ...
 */
public abstract class ExReplyReceivedPost extends L2ServerPacket
{
	/**
	 * A nicer name for {@link ExReplyReceivedPost}.
	 * 
	 * @author savormix (generated)
	 * @see ExReplyReceivedPost
	 */
	public static final class ShowReceivedMailMessage extends ExReplyReceivedPost
	{
		/**
		 * Constructs this packet.
		 * 
		 * @see ExReplyReceivedPost#ExReplyReceivedPost()
		 */
		public ShowReceivedMailMessage()
		{
		}
	}
	
	private static final int[] EXT_OPCODES = { 0xab, 0x00 };
	
	/** Constructs this packet. */
	public ExReplyReceivedPost()
	{
	}

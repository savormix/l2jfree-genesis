 ...
 */
public abstract class InventoryUpdatePacket extends L2ServerPacket
{
	/**
	 * A nicer name for {@link InventoryUpdatePacket}.
	 * 
	 * @author savormix (generated)
	 * @see InventoryUpdatePacket
	 */
	public static final class MyInventoryUpdate extends InventoryUpdatePacket
	{
		/**
		 * Constructs this packet.
		 * 
		 * @see InventoryUpdatePacket#InventoryUpdatePacket()
		 */

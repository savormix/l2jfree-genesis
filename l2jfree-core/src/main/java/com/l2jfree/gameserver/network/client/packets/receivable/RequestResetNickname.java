 ...
 */
public abstract class RequestResetNickname extends L2ClientPacket
{
	/**
	 * A nicer name for {@link RequestResetNickname}.
	 * 
	 * @author savormix (generated)
	 * @see RequestResetNickname
	 */
	...
	public static final int[] EXT_OPCODES = { 0x50, 0x00, };
	/** Second packet's identifier */
	public static final int OPCODE_2 = 0x50;

 ...
 */
public abstract class PackageSendableListPacket extends L2ServerPacket
{
	/**
	 * A nicer name for {@link PackageSendableListPacket}.
	 * 
	 * @author savormix (generated)
	 * @see PackageSendableListPacket
	 */
	public static final class TransferableItemList extends PackageSendableListPacket
	{
		/**
		 * Constructs this packet.
		 * 
		 * @see PackageSendableListPacket#PackageSendableListPacket()
		 */
		public TransferableItemList()
		{
		}
	}

	/** Constructs this packet. */
	public PackageSendableListPacket()
	{
	}
	...
	protected void writeImpl(L2Client client, L2Player activeChar, MMOBuffer buf) throws RuntimeException
	{
		...
		buf.writeD(0); // Receiver's OID
		buf.writeQ(0L); // Adena
		final int sizeA = 0; // Receivable count
		buf.writeD(sizeA);

 ...
 */
public abstract class ShortCutRegisterPacket extends L2ServerPacket
{
	/**
	 * A nicer name for {@link ShortCutRegisterPacket}.
	 * 
	 * @author savormix (generated)
	 * @see ShortCutRegisterPacket
	 */
	public static final class ShortcutAdded extends ShortCutRegisterPacket
	{
		/**
		 * Constructs this packet.
		 * 
		 * @see ShortCutRegisterPacket#ShortCutRegisterPacket()
		 */
		public ShortcutAdded()
		{
		}
	}

	/** Constructs this packet. */
	public ShortCutRegisterPacket()
	{
	}

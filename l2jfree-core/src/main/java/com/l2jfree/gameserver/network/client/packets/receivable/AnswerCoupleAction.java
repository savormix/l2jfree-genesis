 ...
 */
public abstract class AnswerCoupleAction extends L2ClientPacket
{
	/**
	 * A nicer name for {@link AnswerCoupleAction}.
	 * 
	 * @author savormix (generated)
	 * @see AnswerCoupleAction
	 */
	...
	public static final int[] EXT_OPCODES = { 0x7a, 0x00 };
	/** Packet's second identifier */
	public static final int OPCODE_2 = 0x7a;
	
	/** Constructs this packet. */
	public AnswerCoupleAction()
	{
	}

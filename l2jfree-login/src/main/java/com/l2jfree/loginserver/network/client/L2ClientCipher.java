...
public final class L2ClientCipher
{
	 ...
	 */
	public boolean decipher(byte[] raw, final int offset, final int size) throws IOException
	{
		getBlowfishCipher().decrypt(raw, offset, size);
		return NewCipher.verifyChecksum(raw, offset, size);
	}
